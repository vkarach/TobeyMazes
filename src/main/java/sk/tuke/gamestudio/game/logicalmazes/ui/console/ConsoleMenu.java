...
public class ConsoleMenu implements MenuView {
    ...
    @Override
    public Level selectLevel(User user) {
        return levelSelectPage.show(user);
    }

    @Override
    public void winPage(long ms, int pts, boolean tr, boolean sr) {
        winPage.show(ms, pts, tr, sr);
    }

    @Override
    public void leaderboardPage(User user) {
        leaderboardPage.show(user);
    }

    @Override
    public void reviewPage(User user) {
        reviewPage.show(user);
    }
    ...
    @Override
    public ProfileOption authorizedProfilePage(User u) {
        return profilePage.showAuthorized(u);
    }
