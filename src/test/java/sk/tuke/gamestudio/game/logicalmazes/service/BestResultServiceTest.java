...
import sk.tuke.gamestudio.service.impl.JDBC.BestResultServiceJDBC;
...
public class BestResultServiceTest {
    ...
    public void getTopByScoreTest() {
        ...
        try {
            ...
            for (UserScore user : expectedBestUsers) {
                userService.deleteUserByName(user.userName());
            }
        }
    }
    ...
    public void getBestTimeWithoutTimeTest() {
        ...
        try {
            ...
            Long bestTime = bestResultService.getBestTime(userId, 1);
            assertNull(bestTime);
        }
        finally {
            userService.deleteUserByName(userName);
